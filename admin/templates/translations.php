                ...
                <div id="banner-section" class="tab-content active">
                    <div class="settings-section">
                        ...
                        <div class="form-field">
                            ...
                            <input type="text" id="banner_title" name="banner_title" value="<?php echo esc_attr($settings['banner_title'] ?? 'Vi bruker informasjonskapsler (cookies)'); ?>" class="regular-text">
                        ...
                        <div class="form-field">
                            ...
                            <textarea id="banner_text" name="banner_text" rows="4" class="large-text"><?php echo esc_textarea($settings['banner_text'] ?? 'Vi bruker informasjonskapsler for å forbedre brukeropplevelsen, tilby personlig tilpasset innhold og analysere trafikken vår.'); ?></textarea>
                        ...
                        <div class="form-field">
                            ...
                            <input type="text" id="privacy_text" name="privacy_text" value="<?php echo esc_attr($settings['privacy_text'] ?? 'Personvernerklæring'); ?>" class="regular-text">
                        </div>

                        <div class="form-field">
                            <label for="cookie_policy_text"><?php _e('Cookie Policy Link Text', 'custom-cookie-consent'); ?></label>
                            <input type="text" id="cookie_policy_text" name="cookie_policy_text" value="<?php echo esc_attr($settings['cookie_policy_text'] ?? 'Informasjonskapsler'); ?>" class="regular-text">
                        ...
                        <div class="form-field">
                            ...
                            <input type="text" id="close_button_text" name="close_button_text" value="<?php echo esc_attr($settings['close_button_text'] ?? 'Lukk'); ?>" class="regular-text">
                        </div>

                        <div class="form-field">
                            <label for="close_button_aria_label"><?php _e('Close Button Aria Label', 'custom-cookie-consent'); ?></label>
                            <input type="text" id="close_button_aria_label" name="close_button_aria_label" value="<?php echo esc_attr($settings['close_button_aria_label'] ?? 'Lukk cookie-banner'); ?>" class="regular-text">
