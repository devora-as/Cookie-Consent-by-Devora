...
<div class="wrap cookie-consent-admin-wrap">
    ...
    <div class="cookie-consent-admin-nav">
        ...
        <a href="<?php echo esc_url(admin_url('admin.php?page=custom-cookie-design')); ?>">
            <?php esc_html_e('Styling', 'custom-cookie-consent'); ?>
        </a>
    ...
    <div class="cookie-consent-admin-card">
        ...
        <?php else : ?>
            ...
            <table class="cookie-list-table">
                ...
                <tbody>
                    <?php
                    foreach ($detected as $cookieName => $cookie) :
    ...
    <div class="cookie-consent-admin-card">
        ...
        <ol>
            <li><?php echo wp_kses(__('<strong>Passive Scanning:</strong> As an admin user browses the site, cookies are automatically detected and reported.', 'custom-cookie-consent'), array('strong' => array())); ?></li>
            <li><?php echo wp_kses(__('<strong>Manual Scanning:</strong> Trigger a manual scan to actively look for cookies.', 'custom-cookie-consent'), array('strong' => array())); ?></li>
            <li><?php echo wp_kses(__('<strong>Pattern Recognition:</strong> Common cookies are automatically categorized based on naming patterns.', 'custom-cookie-consent'), array('strong' => array())); ?></li>
            <li><?php echo wp_kses(__('<strong>Integration Detection:</strong> Popular plugins and their cookies are automatically recognized.', 'custom-cookie-consent'), array('strong' => array())); ?></li>
            <?php
            ...
            ?>
                <li><?php echo wp_kses(__('<strong>Open Cookie Database:</strong> Enhanced cookie categorization using the comprehensive Open Cookie Database.', 'custom-cookie-consent'), array('strong' => array())); ?>
                    <?php
                    printf(
            ...
            <?php else : ?>
                <li><?php echo wp_kses(__('<strong>Open Cookie Database:</strong> Not enabled. Enable this feature in the settings for enhanced cookie recognition.', 'custom-cookie-consent'), array('strong' => array())); ?></li>
            <?php endif; ?>
        </ol>
