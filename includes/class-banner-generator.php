                ...
                <footer class="cookie-consent-footer">
                    <p class="cookie-consent-links">
                        ...
                        <?php if (!empty($settings['cookie_policy_url'])): ?>
                            <?php if (!empty($settings['privacy_url'])): ?> | <?php endif; ?>
                            <a href="<?php echo esc_js($settings['cookie_policy_url']); ?>" target="_blank" rel="noopener noreferrer"><?php echo esc_js($settings['cookie_policy_text'] ?? 'Informasjonskapsler'); ?></a>
                        <?php endif; ?>
                    </p>
